...
public class DriveCharacterizationCommands {
    ...
    SwerveRequest.SysIdSwerveRotation wheelDiameterRequest = new SwerveRequest.SysIdSwerveRotation();

    private final double WHEEL_DIAMETER_TEST_SPEED = 1;
    private final double WHEEL_DIAMETER_TEST_DURATION = 10;

    public Command characterizeWheelDiameter(CommandSwerveDrivetrain drive) {
