...
public class AutoCommands {
    ...
    //                 .onTrue(Commands.sequence(Commands.waitUntil(intake::hasCoral),
    // prepareL4()));
    ...
    //     /**
    //      * I channelled my inner AP CSA here, I haven't touched normal for loops in a long time,
    // and it
    //      * really shows.
    //      *
    ...
    //             int numberOfCoral, String pathName, List<ScoringPositions.Branch>
    // scoringPositions) {
    ...
    //         routine.active()
    //                 .onTrue(Commands.sequence(toReef.get(0).resetOdometry(),
    // toReef.get(0).cmd()));
